...
### VSCommandTable Modifications

- When modifying `VSCommandTable.vsct`, always directly edit `VSCommandTable.cs` to add the corresponding `PackageIds` constants - don't rely on the VSCT Synchronizer to regenerate them automatically.
